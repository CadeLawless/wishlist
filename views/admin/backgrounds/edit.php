...
<div class="sidebar-main">
    ...
    <div class="content">
        ...
        <div class="form-container">
            ...
            <form method="POST" action="/admin/backgrounds/update">
                ...
                <div class="flex form-flex">
                    ...
                    <div class="large-input">
                        ...
                        <p style="margin-top: 5px; font-size: 0.9em; color: var(--text-secondary);">Filename without extension (e.g., "background1")</p>
                    </div>
